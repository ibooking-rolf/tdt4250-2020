...
/**
 * This is the item provider adapter for a {@link tdt4250.Semester} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SemesterItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addSeasonPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Semester_season_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Semester_season_feature",
								"_UI_Semester_type"),
						Tdt4250Package.Literals.SEMESTER__SEASON, true, false, false,
	...
	protected void addCoursesPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Semester_courses_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Semester_courses_feature",
								"_UI_Semester_type"),
						Tdt4250Package.Literals.SEMESTER__COURSES, true, false, true, null, null, null));
	}
	...
	public String getText(Object object) {
		SemesterType labelValue = ((Semester) object).getSeason();
		String label = labelValue == null ? null : labelValue.toString();
		return label == null || label.length() == 0 ? getString("_UI_Semester_type")
