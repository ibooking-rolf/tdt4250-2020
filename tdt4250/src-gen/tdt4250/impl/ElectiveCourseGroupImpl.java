 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.impl.ElectiveCourseGroupImpl#getCourses <em>Courses</em>}</li>
 *   <li>{@link tdt4250.impl.ElectiveCourseGroupImpl#getProgramme <em>Programme</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ElectiveCourseGroupImpl extends MinimalEObjectImpl.Container implements ElectiveCourseGroup {
	...
	protected EClass eStaticClass() {
		return Tdt4250Package.Literals.ELECTIVE_COURSE_GROUP;
	}
	...
	public EList<Course> getCourses() {
		if (courses == null) {
			courses = new EObjectContainmentEList<Course>(Course.class, this,
					Tdt4250Package.ELECTIVE_COURSE_GROUP__COURSES);
		}
		return courses;
	}
			...
			if (programme != oldProgramme) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Tdt4250Package.ELECTIVE_COURSE_GROUP__PROGRAMME, oldProgramme, programme));
			}
		}
		return programme;
	}
	...
	public NotificationChain basicSetProgramme(Programme newProgramme, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Tdt4250Package.ELECTIVE_COURSE_GROUP__PROGRAMME, oldProgramme, newProgramme);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newProgramme != programme) {
			...
			if (programme != null)
				msgs = ((InternalEObject) programme).eInverseRemove(this,
						Tdt4250Package.PROGRAMME__ELECTIVE_COURSE_GROUP, Programme.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Tdt4250Package.ELECTIVE_COURSE_GROUP__PROGRAMME,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case Tdt4250Package.ELECTIVE_COURSE_GROUP__PROGRAMME:
			if (programme != null)
				msgs = ((InternalEObject) programme).eInverseRemove(this,
						Tdt4250Package.PROGRAMME__ELECTIVE_COURSE_GROUP, Programme.class, msgs);
