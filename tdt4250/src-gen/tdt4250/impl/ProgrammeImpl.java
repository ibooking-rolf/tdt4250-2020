 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.impl.ProgrammeImpl#getName <em>Name</em>}</li>
 *   <li>{@link tdt4250.impl.ProgrammeImpl#getDuration <em>Duration</em>}</li>
 *   <li>{@link tdt4250.impl.ProgrammeImpl#getSemesters <em>Semesters</em>}</li>
 *   <li>{@link tdt4250.impl.ProgrammeImpl#getSpecialization <em>Specialization</em>}</li>
 *   <li>{@link tdt4250.impl.ProgrammeImpl#getMandatoryCourses <em>Mandatory Courses</em>}</li>
 *   <li>{@link tdt4250.impl.ProgrammeImpl#getElectiveCourseGroup <em>Elective Course Group</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProgrammeImpl extends MinimalEObjectImpl.Container implements Programme {
	...
	protected EClass eStaticClass() {
		return Tdt4250Package.Literals.PROGRAMME;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tdt4250Package.PROGRAMME__NAME, oldName, name));
	}
	...
	public void setDuration(ProgrammeLevel newDuration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tdt4250Package.PROGRAMME__DURATION, oldDuration,
					duration));
	}
	...
	public EList<Semester> getSemesters() {
		if (semesters == null) {
			semesters = new EObjectContainmentWithInverseEList<Semester>(Semester.class, this,
					Tdt4250Package.PROGRAMME__SEMESTERS, Tdt4250Package.SEMESTER__PROGRAMME);
		}
		return semesters;
	}
	...
	public NotificationChain basicSetSpecialization(Specialization newSpecialization, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Tdt4250Package.PROGRAMME__SPECIALIZATION, oldSpecialization, newSpecialization);
			if (msgs == null)
				msgs = notification;
			else
	...
	public void setSpecialization(Specialization newSpecialization) {
		if (newSpecialization != specialization) {
			...
			if (specialization != null)
				msgs = ((InternalEObject) specialization).eInverseRemove(this, Tdt4250Package.SPECIALIZATION__PROGRAMME,
						Specialization.class, msgs);
			if (newSpecialization != null)
				msgs = ((InternalEObject) newSpecialization).eInverseAdd(this, Tdt4250Package.SPECIALIZATION__PROGRAMME,
						Specialization.class, msgs);
			msgs = basicSetSpecialization(newSpecialization, msgs);
			if (msgs != null)
				msgs.dispatch();
		} else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tdt4250Package.PROGRAMME__SPECIALIZATION,
			...
			if (mandatoryCourses != oldMandatoryCourses) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Tdt4250Package.PROGRAMME__MANDATORY_COURSES, oldMandatoryCourses, mandatoryCourses));
			}
		}
	...
	public NotificationChain basicSetMandatoryCourses(MandatoryCourseGroup newMandatoryCourses,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Tdt4250Package.PROGRAMME__MANDATORY_COURSES, oldMandatoryCourses, newMandatoryCourses);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newMandatoryCourses != mandatoryCourses) {
			...
			if (mandatoryCourses != null)
				msgs = ((InternalEObject) mandatoryCourses).eInverseRemove(this,
						Tdt4250Package.MANDATORY_COURSE_GROUP__PROGRAMME, MandatoryCourseGroup.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Tdt4250Package.PROGRAMME__MANDATORY_COURSES,
	...
	public ElectiveCourseGroup getElectiveCourseGroup() {
		if (electiveCourseGroup != null && electiveCourseGroup.eIsProxy()) {
			...
			if (electiveCourseGroup != oldElectiveCourseGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							Tdt4250Package.PROGRAMME__ELECTIVE_COURSE_GROUP, oldElectiveCourseGroup,
							electiveCourseGroup));
			}
		}
	...
	public NotificationChain basicSetElectiveCourseGroup(ElectiveCourseGroup newElectiveCourseGroup,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					Tdt4250Package.PROGRAMME__ELECTIVE_COURSE_GROUP, oldElectiveCourseGroup, newElectiveCourseGroup);
			if (msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
		...
		if (newElectiveCourseGroup != electiveCourseGroup) {
			...
			if (electiveCourseGroup != null)
				msgs = ((InternalEObject) electiveCourseGroup).eInverseRemove(this,
						Tdt4250Package.ELECTIVE_COURSE_GROUP__PROGRAMME, ElectiveCourseGroup.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, Tdt4250Package.PROGRAMME__ELECTIVE_COURSE_GROUP,
		...
		case Tdt4250Package.PROGRAMME__SPECIALIZATION:
			if (specialization != null)
				msgs = ((InternalEObject) specialization).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - Tdt4250Package.PROGRAMME__SPECIALIZATION, null, msgs);
			return basicSetSpecialization((Specialization) otherEnd, msgs);
		case Tdt4250Package.PROGRAMME__MANDATORY_COURSES:
			if (mandatoryCourses != null)
				msgs = ((InternalEObject) mandatoryCourses).eInverseRemove(this,
						Tdt4250Package.MANDATORY_COURSE_GROUP__PROGRAMME, MandatoryCourseGroup.class, msgs);
			return basicSetMandatoryCourses((MandatoryCourseGroup) otherEnd, msgs);
		case Tdt4250Package.PROGRAMME__ELECTIVE_COURSE_GROUP:
			if (electiveCourseGroup != null)
				msgs = ((InternalEObject) electiveCourseGroup).eInverseRemove(this,
						Tdt4250Package.ELECTIVE_COURSE_GROUP__PROGRAMME, ElectiveCourseGroup.class, msgs);
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case Tdt4250Package.PROGRAMME___GET_CREDITS:
			return getCredits();
		}
