 ...
 * </p>
 * <ul>
 *   <li>{@link tdt4250.impl.UniversityImpl#getName <em>Name</em>}</li>
 *   <li>{@link tdt4250.impl.UniversityImpl#getProgrammes <em>Programmes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UniversityImpl extends MinimalEObjectImpl.Container implements University {
	...
	protected EClass eStaticClass() {
		return Tdt4250Package.Literals.UNIVERSITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Tdt4250Package.UNIVERSITY__NAME, oldName, name));
	}
	...
	public EList<Programme> getProgrammes() {
		if (programmes == null) {
			programmes = new EObjectResolvingEList<Programme>(Programme.class, this,
					Tdt4250Package.UNIVERSITY__PROGRAMMES);
		}
		return programmes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case Tdt4250Package.UNIVERSITY__NAME:
			return getName();
		case Tdt4250Package.UNIVERSITY__PROGRAMMES:
