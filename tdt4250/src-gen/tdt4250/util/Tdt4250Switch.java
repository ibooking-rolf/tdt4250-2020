...
public class Tdt4250Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Tdt4250Package.MANDATORY_COURSE_GROUP: {
			MandatoryCourseGroup mandatoryCourseGroup = (MandatoryCourseGroup) theEObject;
			T result = caseMandatoryCourseGroup(mandatoryCourseGroup);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Tdt4250Package.ELECTIVE_COURSE_GROUP: {
			ElectiveCourseGroup electiveCourseGroup = (ElectiveCourseGroup) theEObject;
			T result = caseElectiveCourseGroup(electiveCourseGroup);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Mandatory Course Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Mandatory Course Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMandatoryCourseGroup(MandatoryCourseGroup object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Elective Course Group</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Elective Course Group</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseElectiveCourseGroup(ElectiveCourseGroup object) {
		return null;
	}
